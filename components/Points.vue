<template>
  <div class="relative overflow-auto md:px-10 px-2.5 xl:my-26 my-25">
    <div
      class="flex flex-nowrap absolute top-[3.75rem] lg:text-[21.3125rem] md:text-[13.75rem] text-[8.5rem] text-orange"
    >
      <span class="block xl:mr-[18.8125rem] mr-[7.5rem]">от</span>
