<template>
  ...
  <div class="grid grid-cols-8 xl:my-26 my-25 px-10">
    <div class="col-start-1 col-end-3">
      <img src="/images/quality/quality-1.png" alt="Жилой комплекс" width="443" height="500" loading="lazy" />
    </div>
    <div class="col-start-4 col-end-8 mt-[276px]">
      <img src="/images/quality/quality-2.png" alt="Жилой комплекс" width="909" height="561" loading="lazy" />
    </div>
    <div class="col-start-3 col-end-5 mt-[160px]">
      <img src="/images/quality/quality-3.png" alt="Жилой комплекс" width="443" height="500" loading="lazy" />
    </div>
  </div>
